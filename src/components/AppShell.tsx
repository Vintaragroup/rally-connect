...
import { Home, Calendar, Users, TrendingUp, MoreHorizontal } from "lucide-react";

interface AppShellProps {
  children: ReactNode;
  activeTab?: "home" | "schedule" | "teams" | "ratings" | "more";
  title?: string;
  showBack?: boolean;
  onBack?: () => void;
  onTabChange?: (tab: "home" | "schedule" | "teams" | "ratings" | "more") => void;
}
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--color-bg)] w-full mx-auto relative">
      <div className="app-container">
        ...
        {/* Bottom Navigation */}
        <div className="fixed bottom-0 left-0 right-0 bg-[var(--color-bg-elevated)] border-t border-[var(--color-border)] px-2 py-2 safe-area-inset-bottom">
