...
export function AchievementsScreen({ onBack }: AchievementsScreenProps) {
  ...
  const achievements: Achievement[] = [
    ...
    },
    {
      ...
      description: "Don't miss a match for an entire season",
      icon: Calendar,
      color: "text-blue-600",
      bgColor: "bg-blue-100",
      points: 300,
    ...
    },
    {
      id: "a4",
      title: "Team Player",
      description: "Play 50 matches with your team",
      icon: Users,
    ...
    },
    {
      id: "a5",
      title: "Sharpshooter",
      description: "Achieve a 90% win rate in a season",
      icon: Target,
    ...
    },
    {
      id: "a7",
      title: "Legend",
      description: "Reach the top of your division",
      icon: Star,
